...
2. **Mini-plan: five lines, on the issue.** Goal (one sentence) · files touched · seams under test (feeds `/i-code` step 1) · what evidence will prove it done (feeds `/i-prove`) · the main risk. Five honest lines beat five speculative sections.
